...
const teamMembers: TeamMember[] = [
    { name: 'Fasanya OluwaTobIoba', role: 'Founder & CEO', imageUrl: 'https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg' },
    { name: 'Adakole Andrew', role: 'Front-End Developer & Co-Founder', imageUrl: 'https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg' },
    { name: 'Uwagbale David', role: 'Back-End Developer & Co-Gounder', imageUrl: 'https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg' },
    { name: 'Marvelous', role: 'AI/ML Engineer & Co-Founder', imageUrl: 'https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg' },
];
...
const TeamMemberCard: React.FC<TeamMemberCardProps> = ({ member }) => {
  return (
    <div className="group flex flex-col items-center text-center p-6 bg-purple-100/40 rounded-2xl shadow-sm hover:shadow-xl shadow-gray-900/20 hover:shadow-gray-900/40 transition-all duration-300 border border-gray-800 hover:border-gray-700 hover:-translate-y-1">
      <div className="relative w-32 h-32 md:w-40 md:h-40 mb-4">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-400 via-purple-500 to-pink-500 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
        <img
      ...
      <h3 className="text-xl font-bold text-white mb-1 transition-colors duration-300">{member.name}</h3>
      ...
      <div className="flex space-x-3">
        ...
        <a href="#" className="p-2 text-gray-400 hover:text-white bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg" aria-label={`${member.name}'s Instagram profile`}>
          <InstagramIcon />
        </a>
...
// Main Component
const TeamMemberSection= ({ref}) => {
  return (
    <section ref={ref} className="w-full relative bg-gradient-to-br from-black via-purple-900 to-black font-sans transition-colors overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative w-full px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
        ...
        <div className="w-full text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 rounded-full text-sm font-medium mb-6">
